class Sports{
	...
	static void kabbadiTeamMembersJerseyNos(int[] numbers)
	{
		...
		System.out.println("Team Member Jersey Numbers:"+numbers.length);
	...
	static void FootBallTeamMembersSalary(double[] salaries)
	{
		...
		for (int index=0;index<salaries.length;index++)
		{
			...
			System.out.println("Salaries in Million Doller:"+ref);
		}
	}
	...
	static void khokhoTeamMembersCountryCode(String[] names)
	{
		...
		{
			String ref=names[index];
			System.out.println("khokho team players :"+ref);
		}
	}
}